...
| Agent | All agent permissions: `events:read`, `funnels:read`, `funnels:write`, `apps:read`, `apps:write`, `projects:read`, `projects:write`, `metrics:read`, `metrics:write`, `audit_logs:read`, `users:write`, `jobs:read`, `jobs:write`, `issues:read`, `issues:write` |
