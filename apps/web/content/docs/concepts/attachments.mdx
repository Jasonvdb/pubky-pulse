...
- **Soft delete + grace**: `DELETE /v1/attachments/:id` (or the dashboard, or the `delete-attachment` MCP tool) sets `deleted_at`. The `attachment_cleanup` daily job hard-deletes rows after 7 days.
