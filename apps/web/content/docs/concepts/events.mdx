...
| `sdk_name` | string | No | Identifier of the Pubky Pulse SDK that produced the event (e.g. `pubky-pulse-swift`, `pubky-pulse-node`). Auto-set by official SDKs. |
...
- **`sdk_name`** -- identifier of the Pubky Pulse SDK producing the event (e.g. `pubky-pulse-swift`, `pubky-pulse-node`)
