...
Instrument this project with Owlmetry event logging. Connect the Owlmetry
MCP server first (https://owlmetry.com/docs/mcp) — it exposes its integration
guide as the owlmetry://guide resource, and the SDK docs are at
https://owlmetry.com/docs/sdks.
...
- **`sdk_name`** -- identifier of the Owlmetry SDK producing the event (e.g. `owlmetry-swift`, `owlmetry-node`)
- **`sdk_version`** -- version of the Owlmetry SDK producing the event
