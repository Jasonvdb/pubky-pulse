...
Add Owlmetry funnel tracking to this project. Connect the Owlmetry MCP
server first (https://owlmetry.com/docs/mcp) — it exposes its integration
...
- For each journey, define the funnel on the server with the
  ...
  Owl.step("step-name") calls at each progression point in the code.
