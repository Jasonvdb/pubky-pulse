...
User properties are custom key-value pairs stored on each user in Owlmetry. They let you see at a glance what plan a user is on, which cohort they belong to, or any other user-level attribute you care about.
