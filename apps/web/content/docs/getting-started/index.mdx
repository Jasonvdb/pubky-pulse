...
Owlmetry is designed to be set up by your coding agent. The [MCP endpoint](/docs/mcp/setup) is the agent interface: configure a URL once in your editor and your agent gets 81 tools instantly, with no installation and no updates to keep on top of.
