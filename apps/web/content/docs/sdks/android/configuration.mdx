...
| `endpoint` | `String` | required | Your Pubky Pulse ingest server URL. Required — the Android SDK has no default endpoint. |
...
Pulse.configure(
    context = this,
    endpoint = "https://ingest.yourdomain.com",  // required — there is no default
    apiKey = "pulse_client_...",
